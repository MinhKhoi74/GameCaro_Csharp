...
namespace Game_Caro
{
    public partial class Form1 : Form
    {
        ...
        private void pnlChessBeard_Paint(object sender, PaintEventArgs e)
        {

        }

        private void pnlChessBeard_Resize(object sender, EventArgs e)
        {
        }
        ...
        private void pctbXO_Click(object sender, EventArgs e)
        {

        }

        private void pnlChessBeard_DoubleClick(object sender, EventArgs e)
        {

        }

        private void pnlChessBeard_SystemColorsChanged(object sender, EventArgs e)
        {
